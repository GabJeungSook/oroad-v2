                ...
                <li class="col-span-1 flex rounded-md shadow-sm">
                    ...
                    <div class="flex flex-1 items-center justify-between truncate rounded-r-md border-b border-r border-t border-gray-200 bg-white">
                      ...
                      <div class="flex-shrink-0 pr-2">
                        <input {{ in_array($item->id, $selected_ids) ? 'checked' : '' }} wire:click="document_selected({{$item->id}}, {{$item->amount}})" type="checkbox" class="lg:p-3 sm:p-4 mx-2 appearance-none border-2 rounded-md w-6 h-6 border-gray-400">
                      </div>
                    </div>
                  </li>
                @endforeach
