    ...
    <div class="rubik-300 text-3xl text-gray-600">
        <div class="flex justify-between">
            ...
            <div class="flex space-x-4">
                ...
                <a href="{{route('requestor.generate-pdf', ['record' => $record->id])}}"  type="button" class="flex text-sm bg-gray-50 hover:bg-gray-200 p-2 font-semibold rounded-md border-2 border-gray-400 leading-6 rubik-500">
