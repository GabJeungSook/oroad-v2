<nav x-data="{ OpenMobile: false }" @click.away="OpenMobile = false" class="bg-white shadow">
      ...
      <div class="flex h-16 justify-between">
        <div class="flex">
          ...
          <div class="hidden lg:ml-28 lg:flex lg:space-x-8">
            ...
            <a href="{{route('requestor.view-user-profile')}}" wire:navigate class="{{ request()->routeIs('requestor.view-user-profile') ? 'inline-flex items-center border-b-4 rounded-sm border-green-600 px-1 pt-1 text-sm font-semibold text-gray-900 rubik-400' : 'inline-flex items-center border-b-2 border-transparent px-1 pt-1 text-sm font-semibold text-gray-500 hover:border-green-600 hover:text-gray-700 rubik-400'}}">My Profile</a>
    ...
    <div x-cloak x-show.transition.origin.top.right.duration.200="OpenMobile" class="lg:hidden" id="mobile-menu">
      ...
      <div class="space-y-1 pb-3 pt-2">
        ...
        <a href="{{route('requestor.view-user-profile')}}" wire:navigate class="{{request()->routeIs('requestor.view-user-profile') ? 'block border-l-4 border-green-500 bg-indigo-50 py-2 pl-3 pr-4 text-base font-medium text-green-700' : 'block border-l-4 border-transparent py-2 pl-3 pr-4 text-base font-medium text-gray-500 hover:border-gray-300 hover:bg-gray-50 hover:text-gray-700'}}">My Profile</a>
