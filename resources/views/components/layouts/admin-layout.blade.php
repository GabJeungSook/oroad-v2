          ...
          <ul role="list" class="flex flex-1 flex-col gap-y-7">
            <li>
                <li>
                    ...
                    class="{{ request()->routeIs('admin.dashboard') ? 'text-green-600 bg-gray-100' : '' }} rubik-400 hover:text-green-600 hover:bg-gray-50 group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold">
            ...
            <li class="mt-auto">
                <form action="{{route('logout')}}" method="POST">
                    @csrf
                    <button class="group -mx-2 flex gap-x-3 rounded-md p-2 text-sm font-semibold leading-6 text-gray-700 hover:bg-gray-50 hover:text-green-600">
