...
<div>
          ...
          <ul role="list" class="flex flex-1 flex-col gap-y-7">
            <li>
                <li>
                    ...
                    class="{{ request()->routeIs('admin.dashboard') ? 'text-green-600 bg-gray-100' : '' }} hover:text-green-600 hover:bg-gray-50 group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold">
                ...
                <li>
                    ...
                    <ul role="list" class="-mx-2 mt-2 space-y-1">
                        <li>
                          ...
                          class="{{ request()->routeIs('admin.campus') ? 'text-green-600 bg-gray-100' : 'text-gray-700' }} hover:text-green-600 hover:bg-gray-50 group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold">
                        ...
                        <li>
                          <a href="#" class="text-gray-700 hover:text-green-600 hover:bg-gray-50 group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold">
                              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
    ...
    <div class="lg:pl-72">
      ...
      <main class="py-10">
        <div class="px-16 mt-12 text-4xl font-semibold text-gray-700 font-custom">
            @yield('title')
        </div>
        <div class="p-16">
            {{$slot}}
