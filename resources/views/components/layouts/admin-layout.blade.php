            ...
            <li>
              ...
              <ul role="list" class="-mx-2 space-y-1">
                <li>
                    ...
                    class="{{ request()->routeIs('admin.dashboard') ? 'text-green-600 bg-gray-100' : '' }} pb-5 rubik-400 hover:text-green-600 hover:bg-gray-50 group flex gap-x-3 rounded-md py-2 text-sm leading-6 font-semibold">
