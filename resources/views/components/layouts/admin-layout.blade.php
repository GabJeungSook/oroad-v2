...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="bg-dots-darker bg-center bg-gray-100 dark:bg-dots-lighter dark:bg-gray-900 font-sans">
        <!--
...
<div>
                ...
                <li>
                  <ul role="list" class="-mx-2 space-y-1">
                    <li>
                      ...
                      <a href="#" class="bg-gray-50 text-green-600 group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold">
    ...
    <div class="hidden lg:fixed lg:inset-y-0 lg:z-20 lg:flex lg:w-72 lg:flex-col">
      <!-- Sidebar component, swap this element with another sidebar if you like -->
      <div wire:poll class="flex grow flex-col gap-y-5 overflow-y-auto border-r border-gray-200 bg-white px-6 pb-4">
            ...
            <li>
              ...
              <ul role="list" class="-mx-2 space-y-1">
                <li>
                    ...
                    class="{{ request()->routeIs('admin.dashboard') ? 'text-green-600 bg-gray-100' : '' }} mb-5  rubik-400 hover:text-green-600 hover:bg-gray-50 group flex gap-x-3 rounded-md px-1 py-2 text-sm leading-6 font-semibold">
                  ...
                  <li>
                    ...
                    <ul role="list" class="-mx-2 mt-2 space-y-1">
                        <li>
                          ...
                          class="{{ request()->routeIs('admin.campus') ? 'text-green-600 bg-gray-100' : 'text-gray-700' }} rubik-400 hover:text-green-600 hover:bg-gray-50 group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold">
                        ...
                        <li>
                          ...
                          class="{{ request()->routeIs('admin.course') ? 'text-green-600 bg-gray-100' : 'text-gray-700' }} rubik-400 hover:text-green-600 hover:bg-gray-50 group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold">
                              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                        ...
                        <li>
                          ...
                          class="{{ request()->routeIs('admin.user-type') ? 'text-green-600 bg-gray-100' : 'text-gray-700' }} rubik-400 hover:text-green-600 hover:bg-gray-50 group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold">
                              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                        ...
                        <li>
                          ...
                          class="{{ request()->routeIs('admin.document') ? 'text-green-600 bg-gray-100' : 'text-gray-700' }} rubik-400 hover:text-green-600 hover:bg-gray-50 group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold">
                        ...
                        <li>
                            ...
                            class="{{ request()->routeIs('admin.user') ? 'text-green-600 bg-gray-100' : 'text-gray-700' }} rubik-400 hover:text-green-600 hover:bg-gray-50 group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold">
                ...
                <li>
                    ...
                    <ul role="list" class="-mx-2 mt-2 space-y-1">
                      ...
                      <li>
                        <a href="{{route('admin.approved-request')}}" class="{{ request()->routeIs('admin.approved-request') ? 'text-green-600 bg-gray-100' : 'text-gray-700' }} rubik-400 hover:text-green-600 hover:bg-gray-50 group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                      ...
                      <li>
                        <a href="{{route('admin.payment-request')}}" class="{{ request()->routeIs('admin.payment-request') ? 'text-green-600 bg-gray-100' : 'text-gray-700' }} rubik-400 hover:text-green-600 hover:bg-gray-50 group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                      ...
                      <li>
                        <a href="{{route('admin.request-to-claim')}}"  class="{{ request()->routeIs('admin.request-to-claim') ? 'text-green-600 bg-gray-100' : 'text-gray-700' }} rubik-400 hover:text-green-600 hover:bg-gray-50 group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                      ...
                      <li>
                        <a href="{{route('admin.claimed-requests')}}" class="{{ request()->routeIs('admin.claimed-requests') ? 'text-green-600 bg-gray-100' : 'text-gray-700' }} rubik-400 hover:text-green-600 hover:bg-gray-50 group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                      ...
                      <li>
                        <a href="{{route('admin.request-denied')}}" class="{{ request()->routeIs('admin.request-denied') ? 'text-green-600 bg-gray-100' : 'text-gray-700' }} rubik-400 hover:text-green-600 hover:bg-gray-50 group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
